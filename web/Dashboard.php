					...
					<ul>
						...
						<li style = "margin-right:10px;">
                           ...
                           if(isset($_POST['login']))
                            {
								echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/apps/login-page/login.php'</script>";
							}
							?>
						</li>
						<li>
						<script language="JavaScript">
                         ...
                         document.getElementById(id).style.display = visibility;
                           ...
                           if(isset($_POST['signup']))
                            {
								echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/apps/login-page/selectrole.php'</script>";
							}
							?>
						</li>	
                    </ul>
