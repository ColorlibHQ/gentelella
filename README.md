...
* [Gentelella for Blazor WASM](https://github.com/frankodoom/gentelella-blazor) Gentelella admin template bootstrapped with .NET Blazor Wasm webclient project
