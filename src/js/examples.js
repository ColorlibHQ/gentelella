...
function init_DataTables() {
    ...
    var handleDataTableButtons = function () {
        if ($("#datatable-buttons").length) {
            //Fix for DataTable Button using the length menu
            //https://datatables.net/forums/discussion/57313/lengthmenu-and-search-location-not-in-the-same-line
            var btnTable = $("#datatable-buttons").DataTable({
                responsive: true,
                lengthChange: false,
                buttons: [
                    'copyHtml5',
    ...
    var $datatable = $('#datatable-checkbox').dataTable({
        'order': [
            [1, 'asc']
        ],
        'columnDefs': [{
