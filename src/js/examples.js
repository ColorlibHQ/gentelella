...
function init_daterangepicker() {
    ...
    $('#reportrange span').html(dayjs().subtract(29, 'days').format('MMMM D, YYYY') + ' - ' + dayjs().format('MMMM D, YYYY'));
...
function init_daterangepicker_right() {
    ...
    $('#reportrange_right span').html(dayjs().subtract(29, 'days').format('MMMM D, YYYY') + ' - ' + dayjs().format('MMMM D, YYYY'));
...
function init_DataTables() {
    ...
    // Note: Removed iCheck dependency - using modern CSS-only checkbox styling
    // Custom checkboxes are now styled via CSS in the main stylesheet

    TableManageButtons.init();

};

/* CHART - MORRIS REMOVED - Now using Chart.js */
...
function init_agent_performance_chart() {
